...
/**
 * /doctor/onboarding — Physician profile setup form.
 *
 * Called after a physician authenticates via Clerk. Minimal fields only.
 * On submit → POST /api/doctor/onboarding → sets role = PHYSICIAN_PENDING
 * → redirects to /doctor/dashboard (pending verification screen).
 *
 * Protected: middleware.ts ensures a valid Clerk session exists before this
 * page is rendered.
 */
